-- LIMPIAR DATOS PREVIOS (para reiniciar desde cero)
/*
DELETE FROM devoluciones_tiendas;
DELETE FROM devoluciones;
DELETE FROM pedidos_productos;
DELETE FROM pedidos;
DELETE FROM cestas_productos;
DELETE FROM cestas;
DELETE FROM tiendas;
DELETE FROM usuarios;

-- Reiniciar secuencias para que empiecen desde 1
ALTER SEQUENCE usuarios_id_usuario_seq RESTART WITH 1;
ALTER SEQUENCE tiendas_id_tienda_seq RESTART WITH 1;
ALTER SEQUENCE cestas_id_cesta_seq RESTART WITH 1;
ALTER SEQUENCE pedidos_id_pedido_seq RESTART WITH 1;

*/

INSERT INTO tienda_alquemia.usuarios (nombre, apellido1, apellido2, email, contrasena, is_admin) VALUES
...
INSERT INTO tienda_alquemia.cestas (id_usuario, fecha_creacion) VALUES
(1, NOW()),
(3, NOW()),
(4, NOW());

INSERT INTO tienda_alquemia.cestas_productos (id_cesta, id_variante, cantidad) VALUES
(1, 1, 2),
(1, 2, 1),
(2, 3, 1),
(3, 4, 3);

INSERT INTO tienda_alquemia.tiendas (provincia, ciudad, codigo_postal, pais, maps_url) VALUES
...
('Granada', 'Almuñécar', '18690', 'España', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6294482.534097686!2d-5.978224604528674!3d39.616444464022734!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd6a0ba5eb3822b1%3A0x2de91f90e87485c2!2sCoquette!5e0!3m2!1ses!2ses!4v1746909522599!5m2!1ses!2ses'),
...
INSERT INTO tienda_alquemia.pedidos (nombre_envio, apellido1_envio, apellido2_envio, estado, tipo_pedido, fecha, id_usuario, id_tienda, entregado) VALUES
('Ana', 'García', 'López', 'procesando', 'domicilio', CURRENT_DATE, 1, NULL, FALSE),
('Lucía', 'Martínez', 'Sánchez', 'enviado', 'tienda', CURRENT_DATE, 3, 1, FALSE),
('Miguel', 'Ruiz', '', 'entregado', 'domicilio', CURRENT_DATE, 4, NULL, TRUE),
('Pedro', 'Pérez', 'Gómez', 'procesando', 'tienda', CURRENT_DATE, 2, 1, FALSE),
('Laura', 'Jiménez', 'Rodríguez', 'enviado', 'domicilio', CURRENT_DATE, 5, NULL, FALSE),
('Juan', 'González', '', 'entregado', 'tienda', CURRENT_DATE, 6, 2, TRUE),
('Carlos', 'Sánchez', 'Torres', 'procesando', 'domicilio', CURRENT_DATE, 7, NULL, FALSE),
('María', 'López', 'García', 'enviado', 'tienda', CURRENT_DATE, 8, 1, FALSE),
('Raúl', 'Martín', 'Hernández', 'entregado', 'domicilio', CURRENT_DATE, 9, NULL, TRUE),
('Esther', 'Vázquez', 'Castro', 'procesando', 'tienda', CURRENT_DATE, 10, 2, FALSE);

INSERT INTO tienda_alquemia.pedidos_productos (id_pedido, id_variante, cantidad, total_producto) VALUES
...
INSERT INTO tienda_alquemia.devoluciones (descripcion, id_pedido, id_variante) 
VALUES 
...
INSERT INTO tienda_alquemia.devoluciones_tiendas (id_devolucion, id_tienda) 
VALUES 
